"""
Django settings for dovi_api project.
...
ALLOWED_HOSTS = ['api.dholakpur.fun', 'localhost', '0.0.0.0', '127.0.0.1']
...
AWS_PRESIGNED_URL_EXPIRATION = int(os.getenv('AWS_PRESIGNED_URL_EXPIRATION', 3600))
